<?php
//Nos dice en donde esta ubicado el helper
namespace App\Helpers;

class FormatTime {
    //Metodo estatico para poder acceder sin tener que instanciar el objeto siempre. Simplemente el metodo toma la fecha y la formatea con el formato que nos interesa.
    public static function LongTimeFilter($date) {
        ...
        //Cuando termina de formatear no devuelve una fecha de HACE tanto tiempo..
        return "Hace " . $result;
    }
}
